...
@Module({
    controllers: [Visualizzazione_psicologi_amministratoreController, Ricerca_psicologi_amministratoreController, Creazione_psicologo_amministratoreController, Modifica_psicologo_amministratoreController, Eliminazione_psicologo_amministratoreController],
    providers: [Visualizzazione_psicologi_amministratoreService, Ricerca_psicologi_amministratoreService, Creazione_psicologo_amministratoreService, Modifica_psicologo_amministratoreService, Eliminazione_psicologo_amministratoreService],
})

...
@Module({
    controllers: [Visualizzazione_psicologi_amministratoreController, Ricerca_psicologi_amministratoreController, Creazione_psicologo_amministratoreController],
    providers: [Visualizzazione_psicologi_amministratoreService, Ricerca_psicologi_amministratoreService, Creazione_psicologo_amministratoreService],
})
